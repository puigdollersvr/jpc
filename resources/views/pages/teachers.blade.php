...
<head>
    ...
    <title>Team members | Education Center</title>

    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,300,400,600&subset=latin,latin-ext&ver=4.3.1" type="text/css" media="all" />
                ...
                <div class="content_wrap clearfix">
                    ...
                    <nav class="menu_main_nav_area">
                        <ul id="menu_main" class="menu_main_nav">
                            ...
                            <li class="menu-item menu-item-has-children current-menu-ancestor current-menu-parent"><a href="{{URL::to('/teachers')}}">Teachers</a>
                                <ul class="sub-menu">
        ...
        <div class="page_top_wrap page_top_title page_top_breadcrumbs">
            <div class="content_wrap">
                <div class="breadcrumbs">
                    ...
                    <span class="breadcrumbs_item current">Team Members</span>
                </div>
                    ...
                    <section class="post_content">
                                        ...
                                        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                                            ...
                                            <div class="column-1_2 sc_column_item sc_column_item_2 even res_width_100per_imp">
                                                <figure class="sc_image sc_image_shape_square">
                                                    <img src="images/roy_daniels_full-750x422.jpg" alt="" />
                                                </figure>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="sc_section" data-animation="animated fadeInUp normal">
                            <div class="sc_content content_wrap margin_top_3em_imp margin_bottom_3em_imp">
                                <h2 class="sc_title sc_title_regular sc_align_center margin_top_0 margin_bottom_085em text_center">Language Teachers</h2>
                                <div class="sc_team sc_team_style_1" data-animation="animated fadeInUp normal">
                                    <div class="sc_columns columns_wrap">
                                        <div class="column-1_3">
                                            <div class="sc_team_item sc_team_item_1 odd first">
                                                <div class="sc_team_item_avatar">
                                                    <img alt="" src="images/john_johnson_full-350x290.jpg"></div>
                                        ...
                                        <div class="column-1_3">
                                            <div class="sc_team_item sc_team_item_2 even">
                                                <div class="sc_team_item_avatar">
                                                    <img alt="" src="images/john_snow_full-350x290.jpg"></div>
                                                <div class="sc_team_item_info">
                                                    <h6 class="sc_team_item_title">
                                        ...
                                        <div class="column-1_3">
                                            <div class="sc_team_item sc_team_item_3 odd">
                                                <div class="sc_team_item_avatar">
                                                    <img alt="" src="images/pamela_fryman_full-350x290.jpg"></div>
                                                <div class="sc_team_item_info">
                                                    <h6 class="sc_team_item_title">
                                ...
                                <h2 class="sc_title sc_title_regular sc_align_center margin_top_0 margin_bottom_085em text_center" data-animation="animated fadeInUp normal">Marketing</h2>
                                <div class="sc_team sc_team_style_2" data-animation="animated fadeInUp normal">
                                    <div class="sc_columns columns_wrap">
                                        <div class="column-1_3">
                                            <div class="sc_team_item sc_team_item_1 odd first">
                                                <div class="sc_team_item_avatar">
                                                    <img alt="jessie_russel_full.jpg" src="images/jessie_russel_full-350x290.jpg">
                                                ...
                                                <div class="sc_team_item_info">
                                                    <h6 class="sc_team_item_title"><a href="personal-page.html">Jessie Russel</a></h6>
                                                    <div class="sc_team_item_position">Marketing Coordinator</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column-1_3">
                                            <div class="sc_team_item sc_team_item_2 even">
                                                <div class="sc_team_item_avatar">
                                                    <img alt="" src="images/maurice_bates_full-350x290.jpg">
                                                    <div class="sc_team_item_hover">
                                                        <div class="sc_team_item_socials">
                                                            <div class="sc_socials sc_socials_size_small">
                                                                <div class="sc_socials_item">
                                                ...
                                                <div class="sc_team_item_info">
                                                    <h6 class="sc_team_item_title"><a href="personal-page.html">Maurice Bates</a></h6>
                                                    <div class="sc_team_item_position">Marketing Coordinator</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column-1_3">
                                            <div class="sc_team_item sc_team_item_3 odd">
                                                <div class="sc_team_item_avatar">
                                                    <img alt="" src="images/roy_daniels_full-350x290.jpg">
                                                    <div class="sc_team_item_hover">
                                                        <div class="sc_team_item_socials">
                                                            <div class="sc_socials sc_socials_size_small">
                                                                <div class="sc_socials_item">
                                ...
                                <a href="courses-streampage.html" data-animation="animated fadeInUp normal" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_menu sc_button_size_small aligncenter  sc_button_iconed icon-graduation margin_top_0 sc_button_courses_st1 margin_bottom_4 widht_12em">VIEW ALL COURSES</a>
                            </div>
                        </div>
